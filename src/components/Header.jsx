    ...
    return (
        <>
            <div className='flex justify-between items-center py-[10px] lg:pt-[4px] lg:pb-[5.50px] pl-[24px] pr-[7.42px] bg-white rounded-[61.102px] border-b-[4px] border-solid border-black'>
                <h2 className='ff_luckydino lg:text-[39.125px] text-[35px] mt-1 font-normal text-[#FBA11D] leading-[94%] drop-shadow-[0px_1.337px_0px_#000]'>
                    D
                ...
                <div className='flex gap-[136px] items-center'>
                    <ul className={`${nav ? "left-[-100%]" : "left-0"} flex max-lg:fixed gap-[28px] items-center max-lg:top-0 max-lg:h-full max-lg:w-full max-lg:z-[7] max-lg:bg-white max-lg:transition-all max-lg:duration-300 max-lg:ease-linear max-lg:min-h-screen max-lg:flex-col max-lg:justify-center`}>
                        <li><a href="About" className='ff_chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>About</a></li>
                        <li><a href="Tokenomic" className='ff_chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>Tokenomic</a></li>
                        <li><a href="Roadmap" className='ff_chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>Roadmap</a></li>
                        <li><a href="FAQ" className='ff_chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>FAQ</a></li>
                    ...
                    <div className='flex items-center gap-[13px]'>
                        ...
                        <button className='lg:block hidden bg-BgBtnJoin bg-Bgsize bg-BgPositionCenter bg-no-repeat'>
                            <p className='pt-[11px] pb-[19.57px] px-[36px] text-[18px] font-normal text-black ff_chewy leading-[131%]'>Join Now</p>
                        </button>
